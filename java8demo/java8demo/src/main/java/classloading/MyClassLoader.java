...
public class MyClassLoader extends ClassLoader {
  ...
  public Class loadClass(String name) throws ClassNotFoundException {
    ...
    String url = "file:org.demo/target/classes/reflection/Special.class";
    try {
  ...
  public static void main(String[] args) throws
    ...
    Object special1 = (specialClass1.getDeclaredConstructors())[0].newInstance();
    Object special2 = (specialClass1.getDeclaredConstructors())[1].newInstance();
    ...
    try {
      ...
      // preferred way
      if (special2 instanceof SpecialIF) {
